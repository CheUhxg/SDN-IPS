...
public final class PipeconfFactory {
    ...
    public static final PiPipeconfId PIPECONF_ID = new PiPipeconfId("c4-ddos-pipeconf");
    private static final URL P4INFO_URL = PipeconfFactory.class.getResource("/c4ddos.p4info.txt");
    private static final URL BMV2_JSON_URL = PipeconfFactory.class.getResource("/c4ddos.json");
