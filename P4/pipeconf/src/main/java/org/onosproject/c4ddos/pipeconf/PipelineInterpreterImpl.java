...
public final class PipelineInterpreterImpl
    ...
    private static final String T_L3_FWD = "ipv4_forward_table";
    ...
    private static final PiMatchFieldId IP_DST_ID =
            PiMatchFieldId.of(HDR + DOT + IPV4 + DOT + "dstAddr");

    private static final PiTableId TABLE_L3_FWD_ID =
            PiTableId.of(MY_INGRESS + DOT + T_L3_FWD);

    private static final PiActionId ACT_ID_NOP =
            PiActionId.of("NoAction");
    private static final PiActionId ACT_ID_DROP =
            PiActionId.of(MY_INGRESS + DOT + "drop");
    private static final PiActionId ACT_ID_IP_FORWARD =
            PiActionId.of(MY_INGRESS + DOT + "ipv4_forward");
    ...
    private static final Map<Criterion.Type, PiMatchFieldId> CRITERION_MAP =
            ImmutableMap.<Criterion.Type, PiMatchFieldId>builder()
                    ...
                    .put(Criterion.Type.IPV4_DST, IP_DST_ID)
